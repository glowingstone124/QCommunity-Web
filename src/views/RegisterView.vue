      ...
      <h2 v-if="step === 4 && (quiz_seq === -1 || quiz_seq >= 9)">完成年龄认证 - 初中文化水平自助核验测试</h2>
        ...
        <div v-if="step === 4 && quiz_seq <= 8" class="quiz-window">
          ...
          <div v-else>
            ...
            <br/>&emsp;&emsp;这幅璀璨的星图的右前方，有一颗被称作主城北站的亮星。该站始建于2023年，建成初期，南联主城，北临山丘和海洋，系G3线蓝冰化改造后新建的终点站。由于其独特的地理位置，历经多次改造，主城北站已成为铁路联通全物品分类机、末地门，蓝冰高速联通出生点和锡城，并即将开通接入6号线的一级站，既满足了新人前往主城发展的需求，又保障了主城和锡城两个片区人群的往来，日平均客流量稳居全服第一。
